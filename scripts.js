...
const Storage = {
  get: () => JSON.parse(localStorage.getItem("dev.finances:transactions")) || [],
...
const Transaction = {
  ...
  incomes() {
    ...
    Transaction.all.forEach(transaction => {
      //se for maior que zero, soma a uma variável e retornar a variável
...
// Substituir os dados do HTML com os dados os JS
const DOM = {
